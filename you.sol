...
contract youuur is Context, IERC20, Ownable {
	...
	address payable private _marketingWallet = payable(0xB13b86638e0038140C170c8bCD8B560172829b3a);
    
    string private _name = "Youuur";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0x089d698aDc21a095d69494F3236668AdE06f82b6, 'We can not exclude Uniswap router.');
